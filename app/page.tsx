    ...
    <main className={apfel.className}>
      <div className='h-dvh overflow-x-hidden uppercase'>
        <div className='absolute inset-4'>
          <span className={cn(instrument.className, 'leading-2xl absolute left-0 top-0 text-2xl tracking-tight')}>
            next
          </span>
          <span className={cn(apfel.className, 'leading-xl absolute left-1/2 top-0 -translate-x-1/2 text-xl')}>
            next + react three fiber
          </span>
          <span className={cn(instrument.className, 'leading-2xl absolute right-0 top-0 text-2xl')}>THREE</span>
          <span
            className={cn(
              instrument.className,
              'leading-2xl absolute bottom-0 left-1/2 -translate-x-1/2 text-2xl tracking-tight',
            )}
          >
            starter
          </span>
